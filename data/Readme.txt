...
***********which is pre-submitted to OR journal.


The files include the data sets that have already been generated for instances in Table 8 (Appendix EC.3). The users can also use the code to generate more instances for testing.
